...
def createCommandlineParser() -> argparse.ArgumentParser:
    ...
    parser_train_gnn = subparsers.add_parser("traingnn", help="Train new GNN models with your data")
...
def parseTrainGnn(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument('--ignore_columns', type=str,
                        help='Ignore or not the smiles columns')
    ...
    parser.add_argument('--use_input_features', type=str,
                        help='Turn on scaling of features')
    parser.add_argument('--extra_metrics', nargs='*',
    ...
    parser.add_argument('--ffn_hidden_size', type=int, default=2,
    ...
    parser.add_argument('--cuda', action='store_true', default=False,
                        help='Turn on cuda')
    parser.add_argument('--num_lrs', type=int, default=2,
                        help='Number of layers in FFN after MPN encoding')
    parser.add_argument('--minimize_score', type=bool, default=False,
                        help='Number of layers in FFN after MPN encoding')
    parser.add_argument("--loss_function", type=str,
                        choices=['mse', 'bounded_mse', 'binary_cross_entropy', 'cross_entropy', 'mcc', 'sid',
