...
#F="validation/case_MUV/train_AC-generic.json"; if [ -f $F ]; then python -m dfpl train-good1 -f $F; fi
#F="validation/case_MUV/train_AC-specific.json"; if [ -f $F ]; then python -m dfpl train-good1 -f $F; fi
#
#F="validation/case_Tox21/train_AC-generic.json"; if [ -f $F ]; then python -m dfpl train-good1 -f $F; fi
#F= "validation/case_Tox21/train_AC-specific.json"; if [ -f $F ]; then python -m dfpl train-good1 -f $F; fi
#
#F="validation/case_HIV/train_AC-generic.json"; if [ -f $F ]; then python -m dfpl train-good1 -f $F; fi
#F="validation/case_HIV/train_AC-specific.json"; if [ -f $F ]; then python -m dfpl train-good1 -f $F; fi

F="/home/hertelj/git-hertelj/code/deepFPlearn/validation/case_BACE/train_AC-generic.json"; if [ -f $F ]; then python -m dfpl train -f $F; fi
F= "/home/hertelj/git-hertelj/code/deepFPlearn/validation/case_BACE/train_AC-specific.json"; if [ -f $F ]; then python -m dfpl train -f $F; fi
