...
from cmpnnchemprop.data.utils import get_data, get_data_from_smiles
from cmpnnchemprop.utils import load_args, load_checkpoint, load_scalers


def make_predictions(args: options.GnnOptions, smiles: List[str] = None) -> List[Optional[List[float]]]:
    """
