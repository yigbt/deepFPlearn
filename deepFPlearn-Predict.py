...
if __name__ == '__main__':
    ...
    # -m /data/bioinf/projects/data/2019_IDA-chem/deepFPlearn/modeltraining/selectedModels/model.2048.256.ER.checkpoint.model.hdf5
    # -o /data/bioinf/projects/data/2019_IDA-chem/deepFPlearn/prediction/multiAOPtox.smiles.predictions.ER.csv
    # -t smile -k topological
    #xpd = dfpl.XfromInput(csvfilename="/data/bioinf/projects/data/2019_IDA-chem/deepFPlearn/input/multiAOPtox.smiles.csv", rtype="smiles", fptype="topological", printfp=True)
