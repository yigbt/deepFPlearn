...
# Date: Sep 19, 2019
conda create -n rdkit2019 -c conda-forge -c bioconda -c r -c anaconda python pip tensorflow keras numpy pandas rdkit scipy tensorboard matplotlib markdown ncurses pcre yaml pyyaml
